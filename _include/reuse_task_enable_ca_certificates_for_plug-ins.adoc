...
* image:../media/enable_ca_issues_icon.png["문제 아이콘"]* * 는 CA 인증서가 활성화되거나 플러그인 호스트에 할당되지 않았음을 나타냅니다.
...
* image:../media/enable_ca_undefined_icon.png["CA 미완성 아이콘"]* * 는 연결 정보를 검색할 수 없음을 나타냅니다.
+
