...
문제 해결 정보는 을 참조하십시오 link:..https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["여러 탭의 SnapCenter 로그인에 MFA 오류가 표시됩니다"].
