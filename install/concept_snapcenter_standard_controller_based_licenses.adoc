...
+
** image:../media/controller_licensed_icon.gif["컨트롤러 라이센스 아이콘"] FAS 또는 AFF 운영 스토리지 시스템에 SnapManager 제품군 라이센스가 설치되어 있음을 나타냅니다.
** image:../media/controller_not_licensed_icon.gif["컨트롤러 라이센스 없음 아이콘"] FAS 또는 AFF 운영 스토리지 시스템에 SnapManager 제품군 라이센스가 설치되어 있지 않음을 나타냅니다.
...
+
image::../media/nss_controller_license_select.gif[컨트롤러 라이센스를 선택합니다]
...
+
cmdlet에 대한 자세한 내용은 을 https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["SnapCenter 소프트웨어 cmdlet 참조 가이드"^]참조하십시오.
